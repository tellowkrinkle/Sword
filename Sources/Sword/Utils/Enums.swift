  ...
  case guildRoleCreate = "GUILD_ROLE_CREATE"
    ...
    /**
     ...
     bot.on(.guildRoleDelete) { data in
       let (guild, roleID) = data as! (Guild, SnowflakeID)
     }
     ```
    */
    ...
    /**
     ...
     bot.on(.messageDelete) { data in
      guard let (msg, channel) = data as? (Message, Channel) else {
        // data has returned an ID (SnowflakeID)
        let (messageID, channel) = data as! (SnowflakeID, Channel)
        return
      }
     }
     ```
  ...
  case messageDelete = "MESSAGE_DELETE"
    ...
    /**
     ...
     bot.on(.messageDeleteBulk) { data in
       let (messageIDs, channel) = data as! ([SnowflakeID], Channel)
     }
     ```
    */
  case messageDeleteBulk = "MESSAGE_DELETE_BULK"
    ...
    /**
     ...
     bot.on(.messageUpdate) { data in
       let (messageID, channelID) = data as! (SnowflakeID, SnowflakeID)
     }
     ```
    */
  ...
  */
  ...
  /**
   ...
   bot.on(.presenceUpdate) { data in
     let (userID, presence) = data as! (SnowflakeID, Presence)
   }
   ```
  */
  ...
  case shardReady
    ...
    /**
     ...
     bot.on(.typingStart) { data in
       let (channel, userID, timestamp) = data as! (Channel, SnowflakeID, Date)
     }
     ```
    */
  ...
  case userUpdate = "USER_UPDATE"
    ...
    /**
     ...
     bot.on(.voiceChannelJoin) { data in
       let (userID, voiceState) = data as! (SnowflakeID, VoiceState)
     }
     ```
    */
  case voiceChannelJoin
    ...
    /**
     ...
     bot.on(.voiceChannelLeave) { data in
       let userID = data as! SnowflakeID
     }
     ```
    */
