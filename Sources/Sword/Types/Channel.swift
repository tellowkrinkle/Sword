...
public protocol Channel {
  ...
  var id: SnowflakeID { get }

  /// The last message's id
  var lastMessageId: SnowflakeID? { get }

  /// Collection of messages mapped by message id
  var messages: [SnowflakeID: Message] { get }
...
public extension Channel {
  ...
  */
  public func deleteMessage(_ messageId: SnowflakeID, then completion: @escaping (RequestError?) -> () = {_ in}) {
  ...
  */
  public func deleteMessages(_ messages: [SnowflakeID], then completion: @escaping (RequestError?) -> () = {_ in}) {
  ...
  */
  public func editMessage(_ messageId: SnowflakeID, to content: String, then completion: @escaping (Message?, RequestError?) -> () = {_ in}) {
  ...
  **/
  public func getMessage(_ messageId: SnowflakeID, then completion: @escaping (Message?, RequestError?) -> ()) {
  ...
  */
  public func pin(_ messageId: SnowflakeID, then completion: @escaping (RequestError?) -> () = {_ in}) {
  ...
  */
  public func unpin(_ messageId: SnowflakeID, then completion: @escaping (RequestError?) -> () = {_ in}) {
